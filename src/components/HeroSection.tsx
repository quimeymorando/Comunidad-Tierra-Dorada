        ...
        <section className="relative min-h-[100dvh] flex flex-col items-center justify-start text-center px-4 sm:px-6 pt-16 pb-24 md:pt-24 md:pb-32 overflow-hidden bg-[#0A1128]">
            ...
            <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center justify-center">
                ...
                <div className="mb-8 md:mb-12 flex flex-col items-center">
                    <span className="font-heading text-4xl sm:text-5xl md:text-7xl lg:text-[7rem] font-black text-white tracking-tighter drop-shadow-2xl leading-none">
                        TIERRA DORADA
                    </span>
                    <span className="font-serif text-2xl sm:text-3xl md:text-5xl text-gold italic font-light tracking-widest mt-2 md:mt-4 opacity-100 drop-shadow-[0_0_15px_rgba(200,153,51,0.9)] drop-shadow-[0_0_35px_rgba(200,153,51,0.6)]">
                        Comunidad
                    </span>
                </div>

                {/* Description Card - Alargada */}
                <div className="relative mb-10 p-6 md:p-8 rounded-[1.5rem] bg-white/[0.03] backdrop-blur-xl border border-white/10 shadow-xl max-w-4xl mx-auto overflow-hidden group text-center">
                    ...
                    <p className="font-sans text-base sm:text-lg md:text-xl text-white leading-relaxed font-bold drop-shadow-md relative z-10 px-4 md:px-8">
                ...
                {/* Footer Tagline */}
                <div className="mt-8 flex items-center gap-2 text-white/90 text-sm sm:text-base font-sans font-light">
